...
interface ActivityLevelDropdownProps {
  label: string;
...
export function ActivityLevelDropdown({
  label,
  value,
  onChange,
  error,
}: ActivityLevelDropdownProps) {
    ...
    <View className="mb-4">
      ...
      >
        <Text
          ...
          numberOfLines={1}
        >
          {value ? activityLevelLabels[value] : "Select your activity level"}
        </Text>
        <Ionicons
