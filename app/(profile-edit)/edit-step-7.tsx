...
/**
 * Edit Step 7: Cooking Preferences
 * Allows editing of cooking preferences from profile screen
 */
export default function EditStep7Screen() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        Alert.alert("Error", "Failed to load cooking preferences");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <EditScreenLayout
      ...
      description="Update meal plans that fit your lifestyle"
      loading={loading}
    >
      {/* Form Content */}
      <View className="px-6">
