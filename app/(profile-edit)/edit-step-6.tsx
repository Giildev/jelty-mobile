...
/**
 * Edit Step 6: Availability & Schedule
 * Allows editing of availability and schedule from profile screen
 */
export default function EditStep6Screen() {
  ...
  return (
    <EditScreenLayout
      ...
      description="Update when you're available to work out"
      loading={loading}
    >
      <View className="px-6">
        {/* Days Available */}
